...
Dos and Don'ts of writing Go code at Urban Sports. These rules exist to keep the code
base manageable while still allowing engineers to use Go language features
productively.

This guide was originally created by [Uber](https://github.com/uber-go/guide) and adapted to the Urban Sports reality.

This documents idiomatic conventions in Go code that we follow at Urban Sports. A lot
...
import (
  ...
  "github.com/urbansportclub/gokit/log"
)
```
...
that make sense for their projects.
  ...
  [.golangci.yml]: https://github.com/urbansportsclub/go-guide/blob/master/.golangci.yml
